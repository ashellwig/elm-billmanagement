...
var _user$project$Models$initalModel = function (route) {
	return {bills: _krisajenkins$remotedata$RemoteData$Loading, route: route};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {bills: a, route: b};
	});
var _user$project$Models$Bill = F3(
	function (a, b, c) {
		return {category: a, company: b, amount: c};
	});
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$BillRoute = function (a) {
	return {ctor: 'BillRoute', _0: a};
};
var _user$project$Models$BillsRoute = {ctor: 'BillsRoute'};

var _user$project$Msgs$OnBillSave = function (a) {
	return {ctor: 'OnBillSave', _0: a};
};
var _user$project$Msgs$ChangeAmount = F2(
	function (a, b) {
		return {ctor: 'ChangeAmount', _0: a, _1: b};
	});
var _user$project$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Msgs$OnFetchBills = function (a) {
	return {ctor: 'OnFetchBills', _0: a};
};

var _user$project$Routing$billPath = function (category) {
	return A2(_elm_lang$core$Basics_ops['++'], '#bills/', category);
};
var _user$project$Routing$billsPath = '#bills';
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$BillsRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$BillRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('bills'),
					_evancz$url_parser$UrlParser$string)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$BillsRoute,
					_evancz$url_parser$UrlParser$s('bills')),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Bills_Edit$listBtn = A2(
	_elm_lang$html$Html$a,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$billsPath),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fa-chevron-left mr1'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {
...
var _user$project$Bills_Edit$btnAmountIncrease = function (bill) {
	var message = A2(_user$project$Msgs$ChangeAmount, bill, 1);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _user$project$Bills_Edit$btnAmountDecrease = function (bill) {
	var message = A2(_user$project$Msgs$ChangeAmount, bill, -1);
	return A2(
		_elm_lang$html$Html$a,
		{
...
var _user$project$Bills_Edit$formAmount = function (bill) {
	return A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(bill.amount)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Bills_Edit$btnAmountDecrease(bill),
							_1: {
								ctor: '::',
								_0: _user$project$Bills_Edit$btnAmountIncrease(bill),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Bills_Edit$form = function (bill) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(bill.company),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Bills_Edit$formAmount(bill),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Bills_Edit$nav = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Bills_Edit$listBtn,
			_1: {ctor: '[]'}
		});
};
var _user$project$Bills_Edit$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Bills_Edit$nav(model),
			_1: {
				ctor: '::',
				_0: _user$project$Bills_Edit$form(model),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Bills_List$editBtn = function (bill) {
	var path = _user$project$Routing$billPath(bill.category);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _user$project$Bills_List$billRow = function (bill) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(bill.category),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Bills_List$editBtn(bill),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Bills_List$list = function (bills) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Bills_List$billRow, bills)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Bills_List$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Bills'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Bills_List$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$Bills_List$list(_p0._0);
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
	}
};
var _user$project$Bills_List$view = function (response) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Bills_List$nav,
			_1: {
				ctor: '::',
				_0: _user$project$Bills_List$maybeList(response),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Commands$billEncoder = function (bill) {
	var attributes = {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'category',
			_1: _elm_lang$core$Json_Encode$string(bill.category)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'company',
				_1: _elm_lang$core$Json_Encode$string(bill.company)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'amount',
					_1: _elm_lang$core$Json_Encode$int(bill.amount)
				},
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Commands$saveBillUrl = function (billCategory) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://localhost.com:4000/bills/', billCategory);
};
var _user$project$Commands$billDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'category',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Bill))));
var _user$project$Commands$saveBillRequest = function (bill) {
	return _elm_lang$http$Http$request(
		{
			body: _elm_lang$http$Http$jsonBody(
				_user$project$Commands$billEncoder(bill)),
			expect: _elm_lang$http$Http$expectJson(_user$project$Commands$billDecoder),
			headers: {ctor: '[]'},
			method: 'PATCH',
			timeout: _elm_lang$core$Maybe$Nothing,
			url: _user$project$Commands$saveBillUrl(bill.category),
			withCredentials: false
		});
};
var _user$project$Commands$saveBillCmd = function (bill) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$OnBillSave,
		_user$project$Commands$saveBillRequest(bill));
};
var _user$project$Commands$billsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$billDecoder);
var _user$project$Commands$fetchBillsUrl = 'http://localhost:4000/bills';
var _user$project$Commands$fetchBills = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchBills,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchBillsUrl, _user$project$Commands$billsDecoder)));

var _user$project$Update$updateBill = F2(
	function (model, updateBill) {
		var pick = function (currentBill) {
			return _elm_lang$core$Native_Utils.eq(updateBill.category, currentBill.category) ? updateBill : currentBill;
		};
		var updateBillList = function (bills) {
			return A2(_elm_lang$core$List$map, pick, bills);
		};
		var updatedBills = A2(_krisajenkins$remotedata$RemoteData$map, updateBillList, model.bills);
		return _elm_lang$core$Native_Utils.update(
			model,
			{bills: updatedBills});
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'ChangeAmount':
				var _p1 = _p0._0;
				var updatedBill = _elm_lang$core$Native_Utils.update(
					_p1,
					{amount: _p1.amount + _p0._1});
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Commands$saveBillCmd(updatedBill)
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Update$updateBill, model, _p0._0._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _user$project$View$billEditPage = F2(
	function (model, billCategory) {
		var _p0 = model.bills;
		switch (_p0.ctor) {
			case 'NotAsked':
				return _elm_lang$html$Html$text('');
			case 'Loading':
				return _elm_lang$html$Html$text('Loading ...');
			case 'Success':
				var maybeBill = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (bill) {
							return _elm_lang$core$Native_Utils.eq(bill.category, billCategory);
						},
						_p0._0));
				var _p1 = maybeBill;
				if (_p1.ctor === 'Just') {
					return _user$project$Bills_Edit$view(_p1._0);
				} else {
...
var _user$project$View$page = function (model) {
	...
	switch (_p2.ctor) {
		case 'BillsRoute':
			return _user$project$Bills_List$view(model.bills);
		case 'BillRoute':
			return A2(_user$project$View$billEditPage, model, _p2._0);
		default:
			return _user$project$View$notFoundView;
	}
};
...
var _user$project$Main$init = function (location) {
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Models$initalModel(currentRoute),
		_1: _user$project$Commands$fetchBills
	};
};
